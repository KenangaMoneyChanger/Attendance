                ...
                <div id="emp_settings_${key}">
                    <div id="view_${key}">
                        ...
                        <div class="readonly-grid">
                            ...
                            <div class="readonly-row"><span>Overtime Starts</span><strong>18:00</strong></div>
                            <div class="readonly-row"><span>Overtime 6–7PM/hour</span><strong>Rp 10.000</strong></div>
                            <div class="readonly-row"><span>Overtime 7PM+/hour</span><strong>Rp 20.000</strong></div>
                    ...
                    <div id="edit_${key}" style="display:none;">
                        ...
                        <div class="setting-grid">
                            ...
                            <div class="setting-row"><label>Overtime Starts</label><input type="text" value="18:00" disabled style="background:#f0f0f0;color:#999;"></div>
                            <div class="setting-row"><label>Overtime 6–7PM/hour</label><input type="text" value="Rp 10.000" disabled style="background:#f0f0f0;color:#999;"></div>
                            <div class="setting-row"><label>Overtime 7PM+/hour</label><input type="text" value="Rp 20.000" disabled style="background:#f0f0f0;color:#999;"></div>
