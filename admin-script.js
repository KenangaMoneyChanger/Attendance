            ...
            <div class="employee-setting-card">
                ...
                <div id="emp_settings_${key}">
                    ...
                    <div class="setting-grid">
                        ...
                        <div class="setting-row">
                            <label>Overtime starts at (24h, e.g. 17)</label>
                            <input type="number" id="oth_${key}" value="${s.overtimeHour || 17}" placeholder="17" min="0" max="23">
                        </div>
                        <div class="setting-row">
                            <label>Overtime/hour (Rp)</label>
