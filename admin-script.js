                ...
                <div id="emp_settings_${key}">
                    <div id="view_${key}">
                        ...
                        <div class="readonly-grid">
                            ...
                            <div class="readonly-row"><span>Overtime starts at</span><strong>${s.overtimeHour || 19}:00</strong></div>
                    ...
                    <div id="edit_${key}" style="display:none;">
                        ...
                        <div class="setting-grid">
                            ...
                            <div class="setting-row"><label>Overtime starts at (24h)</label><input type="number" id="oth_${key}" value="${s.overtimeHour || 19}" min="0" max="23"></div>
...
function saveOneEmployee(name, key) {
    ...
    employeeSettings[name] = {
        ...
        overtimeHour: parseFloat(document.getElementById(`oth_${key}`)?.value) || 19,
...
function renderSummary(records, month, year) {
    ...
    getEmployees().forEach(name => {
        ...
        empRecords.forEach(r => {
            ...
            if (r.overtimeTier1Minutes) totalTier1Minutes += r.overtimeTier1Minutes;
            if (r.overtimeTier2Minutes) totalTier2Minutes += r.overtimeTier2Minutes;
        });
